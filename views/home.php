...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  <img class="w3-image" src="<?php BASE_URL; ?>assets/images/foto1.jpg" alt="Architecture" width="1500" height="800">
  <div class="w3-display-middle w3-margin-top w3-center">
    <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-green w3-opacity-min"><b>DIDI</b></span> <span class="w3-hide-small w3-text-light-grey">Pedras</span></h1>
  </div>
</header>
...
<!-- Page content -->
  ...
  <div class="w3-container w3-padding-32" id="projects">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Produtos e Serviços</h3>
  </div>
