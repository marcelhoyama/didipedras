...
<head>
    ...
    <meta property="og:image:secure_url" content="http://didipedras.com.br/assets/images/<?php echo $viewData['foto']; ?>"/>
    <meta property="og:image:type" content="image/jpg">

    <meta property="fb:admins" content="werockcontent"/>
    <meta name="twitter:url" content="http://didipedras.com.br/<?php echo $viewData['linknome']; ?>">
    <meta property="twitter:title" content="Procurando <?php echo $viewData['frase']; ?>, qualidade, vendas de pedras ... ">
    ...
    <meta property="twitter:image" content="http://didipedras.com.br/assets/images/<?php echo $viewData['foto']; ?>">
    <meta property="og:type" content="website">
